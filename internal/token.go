...
func newTokenRequest(tokenURL, clientID, clientSecret string, v url.Values, authStyle AuthStyle, authURLEscape bool) (*http.Request, error) {
...
func RetrieveToken(ctx context.Context, clientID, clientSecret, tokenURL string, v url.Values, authStyle AuthStyle, styleCache *AuthStyleCache, authURLEscape bool) (*Token, error) {
	...
	req, err := newTokenRequest(tokenURL, clientID, clientSecret, v, authStyle, authURLEscape)
	if err != nil {
		return nil, err
	}
	...
	if err != nil && needsAuthStyleProbe {
		...
		req, _ = newTokenRequest(tokenURL, clientID, clientSecret, v, authStyle, authURLEscape)
		token, err = doTokenRoundTrip(ctx, req)
	}
